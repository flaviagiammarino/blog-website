...
The agent accesses an Amazon RDS PostgreSQL instance in the same VPC via a postgres-mcp server and communicates with other AWS services through a NAT Gateway.
