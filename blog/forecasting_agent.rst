...
###############################################################################################################
Deploying a basic time series forecasting agent with Strands Agents and Amazon Bedrock AgentCore
###############################################################################################################
...
.. note::
    ...
    In this implementation, the user provides the time series values directly in the chat message.
